 ...
 * cannot see.
 */
public class SchemaServerApplicationSmokeTest {

  @ClassRule
  public static final DropwizardAppRule<SchemaServerConfiguration> SERVER =
      new DropwizardAppRule<>(SchemaServerApplication.class, ResourceHelpers.resourceFilePath("test-config.yml"));
